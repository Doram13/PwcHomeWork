...
namespace PwCHomework.Data
{
    public class ConvertedXML
    {
        ...
        public partial class szamlak
        {
            ...
            private DateTime kezdo_idoField;

            public System.DateTime zaro_idoField;

            public string kezdo_szla_szamField;

            public string zaro_szla_szamField;

            public szamlakSzamla[] szamlaField;
            ...
            public DateTime Export_datumaField { get => Export_datumaField1; set => Export_datumaField1 = value; }
            public DateTime Export_datumaField1 { get; set; }
            public byte Export_szla_dbField { get => export_szla_dbField; set => export_szla_dbField = value; }
            public DateTime Kezdo_idoField { get => kezdo_idoField; set => kezdo_idoField = value; }
        }
